...
namespace SQLiteDBProvider.Translator
{
    ...
    {
        public static string ToInsertSqlCmdParams(this Contracts.Models.AdminInfo req)
        {
        ...
        public static string ToUpdateSqlCmdParams(this Contracts.Models.AdminInfo req)
        {
